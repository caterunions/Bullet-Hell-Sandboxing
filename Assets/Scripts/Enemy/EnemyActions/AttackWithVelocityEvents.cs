...
public class AttackWithVelocityEvents : EnemyAction
{
    ...
    {
        _launcher.Launch(new PatternData(attack.Bullet, attack.Count, attack.Spread, 0f, attack.RandomAngleOffset, DamageTeam.Enemy, DamageType.Neutral, false, new List<ItemEffect>(), null, attack.StartAtFixedAngle ? attack.FixedAngle : null), Stats.DamageMultiplier);
    }
