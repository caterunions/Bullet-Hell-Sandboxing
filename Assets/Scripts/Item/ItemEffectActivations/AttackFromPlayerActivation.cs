...
public class AttackFromPlayerActivation : ItemEffectActivation
{
    ...
    private IEnumerator AttackRoutine()
    {
        ...
        for (int i = 0; i < _attack.Repetitions; i++)
        {
            ...
            _bulletLauncher.Launch(new PatternData(_attack.Bullet, curCount, curSpread, curAngleOffset, _attack.RandomAngleOffset, DamageTeam.Player, _damageType, true, _previousEffectsInChain, null, _attack.StartAtFixedAngle ? _attack.FixedAngle : null), damageMultiplier);
